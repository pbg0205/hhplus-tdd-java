...
@DisplayName("포인트 조회 서비스 단위 테스트")
@ExtendWith(MockitoExtension.class)
class UserPointServiceFindByIdUnitTest {
	...
	@DisplayName("[실패] 충전 포인트가 음수라면 예외를 반환한다")
	@Test
	...
	@DisplayName("[실패] 충전 포인트가 0이라면 예외를 반환한다")
	@Test
	...
	@DisplayName("[실패] 충전 포인트가 10만점을 넘으면 예외를 반환한다")
	@Test
	...
	@DisplayName("[실패] 사용자 식별자가 음수라면 예외를 반환한다")
	@Test
	...
	@DisplayName("[성공] 특정 사용자의 포인트가 정상 충전된다.")
	@Test
